...
public class StudentTimeTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!NetConnectivityCheck.isNetworkAvailable(StudentTimeTable.this)) {
            ViewDialogNet alert = new StudentTimeTable.ViewDialogNet();
            alert.showDialog(StudentTimeTable.this, "Please, enable internet connection before using this app !!");
        }
        ...
        new StudentTimeTable.DownloadImageTask((PhotoView) findViewById(R.id.img))
