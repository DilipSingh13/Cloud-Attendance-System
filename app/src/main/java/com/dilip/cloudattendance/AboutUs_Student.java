...
public class AboutUs_Student extends AppCompatActivity {

    ImageView Instagram,Facebook,Linkedin;
    DatabaseHandler db;
    private HashMap<String, String> user = new HashMap<>();
    String Name,Surname,Urn,Course,Year,Sem,Fullname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Facebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String facebookUrl = getFacebookPageURL(AboutUs_Student.this);
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/profile.php?id=100003179784898";
